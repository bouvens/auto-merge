...
- [x] **REL-09**: README rewrite — секция «Install» с тремя путями (One-click Manifest + Compose+Caddy / Helm / PaaS), DNS-first warning для Compose, troubleshooting секция, ссылки на `/diagnose`
